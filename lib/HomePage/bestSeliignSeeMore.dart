...
class SellingSeeMore extends StatefulWidget {
  @override
  _SellingSeeMoreState createState() => _SellingSeeMoreState();
}

class _SellingSeeMoreState extends State<SellingSeeMore> {
